...
import online.session.AccountSessionStore;
...
public final class OnlineAccountService {
    ...
    public AuthOutcome login(String siteUrl, String identifier, String password) {
        return login(siteUrl, identifier, password, true);
    }

    public AuthOutcome login(String siteUrl, String identifier, String password, boolean rememberSession) {
        clearSessionIfSwitchingSite(siteUrl);
        AuthOutcome outcome = client.login(siteUrl, identifier, password);
    ...
    public AuthOutcome register(String siteUrl, String username, String email, String password) {
        return register(siteUrl, username, email, password, true);
    }

    public AuthOutcome register(String siteUrl, String username, String email, String password, boolean rememberSession) {
        clearSessionIfSwitchingSite(siteUrl);
    ...
    private void persistSession(boolean rememberSession) {
        if (session == null) {
            return;
        }
