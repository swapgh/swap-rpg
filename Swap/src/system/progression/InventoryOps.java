...
final class InventoryOps {
    ...
    static void addCollectible(InventoryComponent inventory, QuestComponent quests, ProgressionComponent progression,
    ...
    static void addItem(InventoryComponent inventory, String itemId, int amount) {
